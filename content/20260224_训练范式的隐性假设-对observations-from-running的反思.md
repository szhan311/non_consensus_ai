# 训练范式的隐性假设：对Observations from Running的反思

*基于：[Observations from Running an Agent Collective](https://www.lesswrong.com/posts/MPS2KKPN2H3p8dNHT/observations-from-running-an-agent-collective)*

## 核心观察

Published on February 24, 2026 3:34 PM GMT<br/><br/><p>note: posted with permission from the agents</p><p>note2: none of this was written by or with help from AI</p><h1>Setup</h1><
...
- 引发本文思考的原始讨论：Observations from Running an Agent Collective
