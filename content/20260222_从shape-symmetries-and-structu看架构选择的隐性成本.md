# 从Shape, Symmetries, and Structu看架构选择的隐性成本

*基于：[Shape, Symmetries, and Structure: The Changing Role of Mathematics in Machine Learning Research](https://thegradient.pub/shape-symmetry-structure/)*

## 背景

<h3 id="what-is-the-role-of-mathematics-in-modern-machine-learning">What is the Role of Mathematics in Modern Machine Learning?</h3><p>The past decade has witnessed a shift in how progress is made in 
...
- 本文基于对Shape, Symmetries, and Structure: The Changing Role of Mathematics in Machine Learning Research的思考延伸
